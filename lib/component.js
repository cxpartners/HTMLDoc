...
Component.prototype.parse = function(body) {
  ...
  for (var key in htmldoc) {
    ...
    if ( typeof value === "string" ) {
      ...
      if ( value.substring(0, 15) === 'content:http://' || value.substring(0, 16) === 'content:https://' ) {
      ...
      else if ( value.substring(0, 15) === 'content:file://') {
        filename = path.resolve(cwd, value.substring(15));
