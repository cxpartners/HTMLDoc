...
An example theme based on [Twitter's Bootstrap](http://getbootstrap.com/) can be found at [https://github.com/cxpartners/htmldoc-bootstrap-styleguide-theme](https://github.com/cxpartners/htmldoc-bootstrap-styleguide-theme).
